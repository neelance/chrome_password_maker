...
(function() {
  var icon_d, icon_e, inputElement, processInput, processing, _i, _len, _ref;
  ...
  processInput = function(oldInput) {
    var copyAttributes, enabled, newId, newInput, observer, parent, setEnabled, _i, _len, _ref;
    ...
    copyAttributes = function() {
      var attrName, i, name, sourceStyle, targetStyle, _i, _j, _len, _ref, _ref1, _results;
      _ref = ["size", "maxlength", "tabindex", "placeholder"];
      ...
      _results = [];
      for (i = _j = 0, _ref1 = sourceStyle.length; 0 <= _ref1 ? _j < _ref1 : _j > _ref1; i = 0 <= _ref1 ? ++_j : --_j) {
